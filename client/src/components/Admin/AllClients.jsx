...
const AllClients = () => {
  ...
  const handleDelete = async (id) => {
    await axios
    .delete(`${server}/client/delete-client/${id}`, { withCredentials: true })
    .then((res) => {
  ...
  const columns = [
...

    {
      ...
      renderCell: (params) => {
        return (
          <>
            <Button onClick={() => setClientId(params.id) || setOpen(true)}>
            ...
            <div className="w-[95%] 800px:w-[40%] min-h-[20vh] bg-white rounded shadow p-5">
              ...
              <div className="w-full flex items-center justify-center">
                ...
                <div
                  ...
                  onClick={() =>  setOpen(false) || handleDelete(clientId)}
                >
                  confirm
                </div>
              </div>
